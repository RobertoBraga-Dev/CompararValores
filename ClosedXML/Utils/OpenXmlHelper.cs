...
namespace ClosedXML.Utils
{
    internal static class OpenXmlHelper
    {
        ...
        public static XLColor ToClosedXMLColor(this ColorType openXMLColor, IDictionary<string, ImageSharp.Color> colorCache = null)
        {
        ...
        /// <param name="colorCache">The dictionary containing parsed colors to optimize performance.</param>
        /// <returns>The color in ClosedXML format.</returns>
        public static XLColor ToClosedXMLColor(this X14.ColorType openXMLColor, IDictionary<string, ImageSharp.Color> colorCache = null)
        {
        ...
        /// <param name="colorCache">The dictionary containing parsed colors to optimize performance.</param>
        /// <returns>The color in ClosedXML format.</returns>
        private static XLColor ConvertToClosedXMLColor(IColorTypeAdapter openXMLColor, IDictionary<string, ImageSharp.Color> colorCache )
        {
            XLColor retVal = null;
            if (openXMLColor != null)
            {
                if (openXMLColor.Rgb != null)
                {
                    ...
                    if (colorCache == null || !colorCache.TryGetValue(htmlColor, out ImageSharp.Color thisColor))
                    {
                        thisColor = ColorExtensions.ParseArgbHex(htmlColor);
        ...
        private static void FillFromClosedXMLColor(IColorTypeAdapter openXMLColor, XLColor xlColor, bool isDifferential)
        {
            ...
            switch (xlColor.ColorType)
            {
                case XLColorType.Color:
                    openXMLColor.Rgb = xlColor.Color.ToArgbHex();
                    break;
